...
class Up(nn.Module):
    ...
    def forward(self, x1, x2):
        ...
        # https://github.com/HaiyongJiang/U-Net-Pytorch-Unstructured-Buggy/commit/0e8545022fd8a58a288f7111c24828dbad34177c
...
class UNet(nn.Module):
    def __init__(self, in_channels=3, num_classes=2, base_features=64, bilinear=False):
